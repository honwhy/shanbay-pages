<template>
  <main class="pt-20 max-w-4xl mx-auto px-4 pb-16">
    <article class="prose dark:prose-invert prose-lg max-w-none">
      <div class="pt-32 flex items-center justify-center">
            <pre>                <code>
        Shanbay-ext (以下简称插件) 是一款利用 Shanbay (shanbay.com) 的 API，给用户提供在阅读英文网页时候便利的查询单词含义及发音的工具。
...
useHead({
  title: '隐私政策',
  meta: [
    { name: 'description', content: 'Shanbay browser extension privacy policy - Learn how we protect your data and privacy.' }
  ]
})
</script>
